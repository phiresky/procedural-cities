...
declare module PIXI {
  ...
  export module interaction {
    ...
    export class InteractionManager {
      ...
      protected processMouseDown: (
        displayObject: DisplayObject,
        hit: boolean,
      ) => void;
      protected onMouseUp: (event: Event) => void;
      protected processMouseUp: (
        displayObject: DisplayObject,
        hit: boolean,
      ) => void;
      ...
      processInteractive(
        point: Point,
        displayObject: DisplayObject,
        func: (displayObject: DisplayObject, hit: boolean) => void,
        hitTest: boolean,
        interactive: boolean,
      ): boolean;
      destroy(): void;
  ...
  export module mesh {
    export class Mesh extends Container {
      ...
      protected _renderCanvasTriangleMesh(
        context: CanvasRenderingContext2D,
      ): void;
      protected _renderCanvasTriangles(context: CanvasRenderingContext2D): void;
      protected _renderCanvasDrawTriangle(
        context: CanvasRenderingContext2D,
        vertices: number,
        uvs: number,
        index0: number,
