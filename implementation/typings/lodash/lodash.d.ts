...
declare module _ {
  ...
  interface LoDashImplicitArrayWrapper<T> {
     ...
     * @param pluckValue _.pluck style callback
     **/
    uniq(isSorted: boolean, pluckValue: string): LoDashImplicitArrayWrapper<T>;
     ...
     * @param whereValue _.where style callback
     **/
    uniq<W>(isSorted: boolean, whereValue: W): LoDashImplicitArrayWrapper<T>;
     ...
     * @param whereValue _.where style callback
     **/
    unique<W>(isSorted: boolean, whereValue: W): LoDashImplicitArrayWrapper<T>;
  ...
  interface LoDashStatic {
     ...
     **/
    bind(func: Function, thisArg: any, ...args: any[]): (...args: any[]) => any;
  }
  ...
  interface LoDashImplicitObjectWrapper<T> {
     ...
     * @see _.bindKey
     **/
    bindKey(key: string, ...args: any[]): LoDashImplicitObjectWrapper<Function>;
  }
  ...
  interface LoDashImplicitWrapper<T> {
     ...
     * @see _.clone
     */
    clone(isDeep?: boolean, customizer?: (value: any) => any, thisArg?: any): T;
  ...
  interface LoDashStatic {
     ...
     */
    cloneDeep<T>(value: T, customizer?: (value: any) => any, thisArg?: any): T;
  }
